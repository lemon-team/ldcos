...
public final class FileTypeJudge {
	...
	private static String getFileContent(byte[] bf) throws IOException {
		byte[] b = new byte[28];
		InputStream inputStream = null;
		try {
			inputStream = new ByteArrayInputStream(bf);
	...
	public static FileType getType(byte[] bf) throws IOException {
		String fileHead = getFileContent(bf);
